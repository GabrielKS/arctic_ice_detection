# Given a directory of images, optionally applies thresholding, overlays them,
# then draws the results with interactively adjustable distortion.
# Control the distortion by moving the mouse: x-axis for coefficient 1, y-axis for coefficient 2.
# Read the parameters from standard output for future use.
...
threshold_image = True  # Whether to apply some thresholding to the image
focal_length = 10
